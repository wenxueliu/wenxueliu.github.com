...
[reference here](https://stackoverflow.com/questions/17989306/what-does-docker-add-to-just-plain-lxc)
...
<img src="{{ IMAGE_PATH }}/docer/docker-filesystems-debian.png" width="300" title="image" />

In Docker terminology, a read-only [Layer](http://docs.docker.com/terms/layer/#layer-def) is called an image. An image never changes.

Since Docker uses a [Union File System](http://docs.docker.com/terms/layer/#ufs-def), the processes think the whole file system is mounted read-write. But all the changes go to the top-most writeable layer, and underneath, the original file in the read-only image is unchanged. Since images dont change, images do not have state.

<img src="{{ IMAGE_PATH }}/docker/docker-filesystems-debianrw.png" />
...
</img src="{{ IMAGE_PATH }}/docker/docker-filesystems-busyboxrw.png" title="Container" width="800"/>
