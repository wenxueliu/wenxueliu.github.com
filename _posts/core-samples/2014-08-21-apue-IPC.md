...
* pipes can be used only for linear connections between processes
...
* prevents writing the data to an intermediate disk file, as well PIPE
...
key_t, which is often defined as a long integer in the header
...
####Permission Structure
        ...
        change by msgctl, semctl, shmctl
